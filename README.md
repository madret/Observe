...
# Parse, extract and interact with data
...
For a quick win and to get started interacting with eventlog data (JSON format in the Body), extract fields with the following regex for OPAL syntax:
```
